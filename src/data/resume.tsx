...
export const DATA = {
  ...
  initials: "SK",
  url: "https://hameed-portfolio-381.web.app",
  location: "Guntur",
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        url: "https://www.linkedin.com/in/hameedullah-shaik-249046182/",
        icon: Icons.linkedin,
      },
      X: {
        url: "https://x.com/hameedsk381",
        icon: Icons.x,
      },
      Youtube: {
        url: "https://youtube.com/c/hameedsk381",
        icon: Icons.youtube,
      },
      whatsapp:{
  ...
  work: [
    {
      ...
      logoUrl: "https://pbs.twimg.com/profile_images/1656162046604640256/jBEHWw9o_400x400.png",
      start: "Jan 2023",
      end: "Nov 2023",
      description:
        "Built UI Templates to train AI modals,Web scrapping the UI components,Managed a team of 20 React interns ",
    },
    {
      company: "Servelots",
      badges: [],
      href: "https://janastu.org",
      location: "Remote",
      title: "Software Engineer",
  ...
  education: [
    {
      ...
      degree: "Bachelor's Degree of Computer Science (BTech)",
      logoUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3bqqQPHBthzr0ya3vqkR_0qMqYHQVkrbNZ5X1Js5J0uVWppFkzOG5CEOU7GqgQ35iXOo&usqp=CAU",
    ...
    },
    {
      ...
      href: "https://www.rbschools.in/",
      degree: "Bachelor's Degree of Business Administration (BBA)",
      logoUrl: "https://www.rbschools.in/images/logo.png",
      start: "2016",
      end: "2021",
    }
  ],
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "School Web site with application for homeworks and management",
      technologies: [
        "React.js",
        "Typescript",
        "MongoDB",
    ...
    {
      title: "Renarration",
      href: "https://sweets.janastu.org",
      dates: "Jan 2023 - Present",
      active: true,
      description:
        "Designed, developed Renarration app for renarrating existing web content for technically low literate people.",
      technologies: [
        "React.js",
        "Typescript",
        "MongoDB",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/hameedsk381/renarration-ui",
